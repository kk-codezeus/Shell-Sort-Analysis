...
class KnuthShellSort
{
    ...
    public:
        ...
        void generateKnuthGapSequence(int n)
        {
            int i = 1;
            while(int((pow(3,i) - 1.0) / 2.0) < n)
            {
                gapSequence.push_back(int((pow(3,i) - 1.0) / 2.0));
                i++;
            }
        }
        ...
        void KnuthSeqShellSort(vector<int> &dist)
        {
            int n = dist.size();
...
int main()
{
    ...
    {
        sequence.generateKnuthGapSequence(n);
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.KnuthSeqShellSort(sequence.unifDistPerm);
    ...
    for(int n = 10;n <= 1000000;n *= 10)
    {
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.KnuthSeqShellSort(sequence.almostSortedPerm);
