...
class A036562ShellSort
{
    ...
    public:
        ...
        void generateA036562GapSequence(int n)
        {
            int i = 0;
            gapSequence.push_back(1);
            while(int(pow(4,i + 1) + 3 * pow(2,i) + 1) < n)
            {
                gapSequence.push_back(int(pow(4,i + 1) + 3 * pow(2,i) + 1));
                i++;
            }
        }
        ...
        void A036562SeqShellSort(vector<int> &dist)
        {
            int n = dist.size();
...
int main()
{
    ...
    {
        sequence.generateA036562GapSequence(n);
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.A036562SeqShellSort(sequence.unifDistPerm);
    ...
    for(int n = 10;n <= 1000000;n *= 10)
    {
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.A036562SeqShellSort(sequence.almostSortedPerm);
