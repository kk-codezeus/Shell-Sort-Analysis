...
class powerOfTwoShellSort
{
    ...
    public:
        ...
        void generateGapSequence(int n)
        {
            gapSequence.clear();
            for(int k = 1; int(pow(2,k)) - 1 < n;k++)
                gapSequence.push_back(int(pow(2,k) - 1));
        }
        ...
        void powerof2ShellSort(vector<int> &dist)
        {
            int n = dist.size();
...
int main()
{
    ...
    {
        sequence.generateGapSequence(n);
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.powerof2ShellSort(sequence.unifDistPerm);
    ...
    for(int n = 10;n <= 1000000;n *= 10)
    {
        ...
        for(int i = 0;i < 10;i++)
        {
            ...
            sequence.powerof2ShellSort(sequence.almostSortedPerm);
